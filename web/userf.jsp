        ...
        <div class="container py-xl-5 py-lg-3">
            ...
            <div class="row">
                ...
                <div class="col-lg-6 pr-xl-5 mt-4">
                    ...
                    <p class="sub-para" ><h4>Les formations que vous avez suivi sont :</h4></p>
                <br>
                <br>
                    <%
                  
                        Iterator t=f1.getFormations().iterator();
                        Iterator it ;
                        Formation f=new Formation();
                         while(t.hasNext())
                        {
                        f=(Formation)t.next();
                        out.println("<p class='sub-para'>");
...
<label class='col-form-label' style='margin-left:1090px;'>
                           
  <a href="ressource.jsp?id=<%= id %>"  style="font-size: 30px; color:red ;text-decoration: underline;">Ressource</a></label>
