...
<body>
    ...
    <div class="main-temps-amkpvt mian-content-amk-tems1 text-center" id="home">
        <div class="container">
            ...
            <input type="text" placeholder="Recherche" name="nom" style="margin-top: 60px; margin-left:800px;" >
            <button type="submit"class="fa fa-search"  aria-hidden="true" ></button>
            </form>
            <div class="style-banner mx-auto" style='margin-top: -150px;'>
    ...
    <!-- move top icon -->
    <a href="index.jsp" class="move-top text-center">
