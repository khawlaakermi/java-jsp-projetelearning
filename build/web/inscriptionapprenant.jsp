   ...
   <div class="inner-banner-temps-amkls py-5" id="home">
        <div class="container py-xl-5 py-lg-3">
            ...
            <div class="modal-body mt-md-2 mt-5">
                <h3 class="title-temps-amk mb-5 text-center text-wh font-weight-bold">Apprenant Inscription</h3>
                <form action="ajouterAprenant" method="post">
                   ...
                   <label class="col-form-label">Nos Formations :</label>
                   <br>
                        ...
                        out.println("<input type='checkbox' name ='id1' value ="+s.getId()+">"+s.getNom());
